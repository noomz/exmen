...
#ifndef EXMEN_SWIFT_H
#define EXMEN_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Exmen",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC5Exmen19ServiceOutputWindow")
@interface ServiceOutputWindow : NSWindowController <NSWindowDelegate>
